...
export interface ModuleDoctorScheduleTimeProps {
  initialPathname?: string;
  routingStrategy?: RoutingStrategy;
}

export function ModuleDoctorScheduleTime({
  initialPathname,
  routingStrategy,
}: ModuleDoctorScheduleTimeProps) {
...
export default ModuleDoctorScheduleTime;
