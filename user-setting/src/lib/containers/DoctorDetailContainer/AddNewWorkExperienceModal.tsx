...
import { useCreateDoctorWorkExperienceMutation } from "src/lib/services";
...
const AddNewWorkExperienceModal = ({ handleClose, doctorId }: Props) => {
    ...
    if (doctorId) {
      createWorkExperience({
        ...
        .then((value) => {
          ...
          openNotification({
            type: "success",
            message: "Add new work experience successfully",
          });
        });
    }
  };
...
export default AddNewWorkExperienceModal;
